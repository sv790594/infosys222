...
### Chinook
[<i class="fab fa-creative-commons"></i>](https://creativecommons.org/licenses/by/4.0/) [Johnny Chan](mailto:jh.chan@auckland.ac.nz) | <i class="fas fa-calendar"></i> 2020-09-28
...
- The database can be created by running a single [SQL script](chinook.sql)
